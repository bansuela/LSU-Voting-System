...
const Vote = () => {
    ...
    return (
        <>
            ...
            <div className="no">
                <Container className="c" style={{ backgroundColor: "green" }}>
                ...
                <Container className="co" style={{ backgroundColor: "green" }}>
                ...
                <Container className="con" style={{ backgroundColor: "green" }}>
                ...
                <Container className="cons" style={{ backgroundColor: "green" }}>
                ...
                <Container className="const" style={{ backgroundColor: "green" }}>
                ...
                <Container className="constan" style={{ backgroundColor: "green" }}>
                ...
                <Container className="constant" style={{ backgroundColor: "green" }}>
                ...
                <Container className="constanta" style={{ backgroundColor: "green" }}>
